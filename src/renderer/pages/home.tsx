  ...
  return (
    <div id="home" className="p-4">
      ...
      <aside
        ...
        id="asside"
        className="transition ease-in-out delay-150 drop-shadow-2xl bg-gray-300  dark:bg-dark-200 dark:text-treetech-50 text-center w-1/4 absolute left-0 rounded-e-md h-5/6"
      >
